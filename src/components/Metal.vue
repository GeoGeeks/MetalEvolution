        ...
        <div id="containerMapa">
            <div  class="row">
                ...
                <div class="col-3 alto">
                    ...
                    <h3 class="text-center card-header"><a target="_blank" v-bind:href="linkRadio" class="btn btn-primary">Escucha</a></h3>
                </div>
            </div>
        </div>
        <div id="containerBotones d-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-2 d-flex flex-column justify-content-center">
                    ...
                    <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-26.png">Pre-Metal</label>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center">
                    <!--espacio vacio para maquetado-->
                    <ul>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-20.png">Progressive Rock.</label></li>
                        <li><label v-on:click="titulo='Early Metal U.S.';mostrarDescripción();
                        createMap(0,0,0,'earlyMetalUS')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-27.png">Early Metal U.S.</label></li>
                        <li><label v-on:click="titulo='Early Metal U.k.';mostrarDescripción();
                        createMap(0,0,0,'earlyMetalUK')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-13.png">Early Metal U.K.</label></li>
                        <li><label v-on:click="titulo='Shock Rock';mostrarDescripción();shockRock
                        createMap(0,0,0,'shockRock')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-11.png">Shock Rock</label></li>
                        <li><label v-on:click="titulo='Punk';mostrarDescripción();
                        createMap(0,0,0,'originalPunk')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-09.png">Punk</label></li>
                    </ul>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center">
                    <!--espacio vacio para maquetado-->
                    <ul>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-21.png">Progressive Metal</label></li>
                        <li><label v-on:click="titulo='Power Metal';mostrarDescripción();
                        createMap(0,0,0,'powerMetal')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-23.png">Power Metal</label></li>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-16.png">N.W.B.H.M.</label></li>
                        <li><label v-on:click="titulo='HardCore';mostrarDescripción();
                        createMap(0,0,0,'hardcore')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-06.png">HardCore</label></li>
                    </ul>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center">
                    <!--espacio vacio para maquetado-->
                    <ul>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-04.png">Doom Metal</label></li>
                        <li><label v-on:click="titulo='Glam Metal/Hard Rock';mostrarDescripción();
                        createMap(0,0,0,'glamhardrock')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-14.png">Glam/Hard Rock</label></li>
                        <li><label v-on:click="titulo='Grunge';mostrarDescripción();
                        createMap(0,0,0,'grunge')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-07.png">Grunge</label></li>
                        <li><label v-on:click="titulo='Thrash Metal';mostrarDescripción();
                        createMap(0,0,0,'thrash')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-15.png">Thrash Metal</label></li>
                        <li><label v-on:click="titulo='Fisrt Wave Of Black Metal';mostrarDescripción();
                        createMap(0,0,0,'fioblack')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-02.png">F.W.Black Metal</label></li>
                        <!-- <li><label v-on:click="titulo='Industrial Metal';mostrarDescripción()
                        " type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-05.png">Industrial Metal</label></li> -->
                    </ul>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center">
                    <!--espacio vacio para maquetado-->
                    <ul>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-12.png">Hard Alternative</label></li>
                        <li><label v-on:click="titulo='MetalCore';mostrarDescripción();
                        createMap(0,0,0,'metalCore')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-22.png">Metalcore</label></li>
                        <li><label v-on:click="titulo='Death Metal';mostrarDescripción();
                        createMap(0,0,0,'deathMetal')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-17.png">Death Metal</label></li>
                        <!-- <li><label v-on:click="titulo='Grindcore';mostrarDescripción()
                        " type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-01.png">Grindcore</label></li> -->
                        <li><label v-on:click="titulo='Black Metal';mostrarDescripción();
                        createMap(0,0,0,'blackMetal')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-03.png">Black Metal</label></li>
                    </ul>
                </div>
                <div class="col-2 d-flex flex-column justify-content-center">
                    <!--espacio vacio para maquetado-->
                    <ul>
                        ...
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-08.png">Goth Metal</label></li>
                        <li><label v-on:click="titulo='Nu Metal';mostrarDescripción();
                        createMap(0,0,0,'nuMetal')" type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-29.png">Nu Metal</label></li>
                        <!-- <li><label v-on:click="titulo='Wave Of American Metal';mostrarDescripción()
                        " type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-28.png">N.W.American Metal</label></li>
                        <li><label v-on:click="titulo='Swedish Extreme Metal';mostrarDescripción()
                        " type="label" class=" badge ">
                        <img class="iconoGenero" src="http://geoapps.esri.co/assetsMetalMap/pines_metal-18.png">Swedish Extreme Metal</label></li> -->
                    </ul>
                </div>
            </div>
        </div>
...
export default {
    ...
    data(){
        return{
            ...
            linkRadio:'https://open.spotify.com/user/1234829347/playlist/1qBYhE4zINyWjcMsyRENlw?si=mm-rvmAMS4KZTSih9u03_Q',
            capa:''
        }
    },
    methods:{
